...
// Vi ville att det skulle vara tydligt såklart hur mycket pengar de skänkt men också hur stor skillnad det gjort för klimatet när användaren valt att gå istället för att använda bilen.
// Siffrorna på "Thank-You"- sidan säger allt.
